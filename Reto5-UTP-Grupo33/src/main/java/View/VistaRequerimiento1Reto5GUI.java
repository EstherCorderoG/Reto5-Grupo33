 ...
 */
public class VistaRequerimiento1Reto5GUI extends javax.swing.JFrame {

    /**
     * Creates new form VistaRequerimiento1Reto5GUI
     */
    DefaultTableModel model;
    public VistaRequerimiento1Reto5GUI() {
        initComponents();
        ...
        jTable1.setModel(model); // instalnciar tabla
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRequerimiento1Reto5GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaRequerimiento1Reto5GUI().setVisible(true);
            }
        });
    }
